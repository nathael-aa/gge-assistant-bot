...
class CalendrierCog(commands.GroupCog, group_name="calendar", group_description="Event calendar management"):
    def __init__(self, bot: commands.Bot):
        ...
        self.event_mapping = {
            ...
            "grand tournament": {"name_key": "cal_ev_tournament", "name_default": "Grand Tournoi", "emoji": "<:grandtournament:1514704234128343040>", "color": 0xD35400, "tracker_name": None, "start": "11:00", "end": "11:00"},
